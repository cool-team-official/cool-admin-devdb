...
) ENGINE=InnoDB AUTO_INCREMENT=4865 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- ----------------------------
-- Records of base_sys_log
-- ----------------------------
BEGIN;
INSERT INTO `base_sys_log` VALUES (4844, '2021-05-28 11:35:54.240109', '2021-05-28 11:35:54.240109', NULL, '/admin/base/open/captcha', '127.0.0.1', '本机地址', '{\"height\":\"36\",\"width\":\"110\"}');
INSERT INTO `base_sys_log` VALUES (4845, '2021-05-28 11:36:00.637132', '2021-05-28 11:36:00.637132', NULL, '/admin/base/open/login', '127.0.0.1', '本机地址', '{\"username\":\"admin\",\"password\":\"123456\",\"captchaId\":\"ceb877d0-bf65-11eb-b58a-edc937979c85\",\"verifyCode\":\"4706\"}');
INSERT INTO `base_sys_log` VALUES (4846, '2021-05-28 11:36:00.998691', '2021-05-28 11:36:00.998691', 1, '/admin/base/comm/person', '127.0.0.1', '本机地址', NULL);
INSERT INTO `base_sys_log` VALUES (4847, '2021-05-28 11:36:01.079081', '2021-05-28 11:36:01.079081', 1, '/admin/base/comm/permmenu', '127.0.0.1', '本机地址', NULL);
INSERT INTO `base_sys_log` VALUES (4848, '2021-05-28 11:36:11.280265', '2021-05-28 11:36:11.280265', 1, '/admin/base/plugin/info/list', '127.0.0.1', '本机地址', '{\"page\":1,\"size\":20,\"sort\":\"desc\",\"order\":\"createTime\"}');
INSERT INTO `base_sys_log` VALUES (4849, '2021-05-28 11:36:18.916050', '2021-05-28 11:36:18.916050', 1, '/admin/base/plugin/info/getConfig', '127.0.0.1', '本机地址', '{\"namespace\":\"socket\"}');
INSERT INTO `base_sys_log` VALUES (4850, '2021-05-28 13:40:58.286498', '2021-05-28 13:40:58.286498', NULL, '/admin/base/open/refreshToken', '127.0.0.1', '本机地址', '{\"refreshToken\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc1JlZnJlc2giOnRydWUsInJvbGVJZHMiOlsiMSJdLCJ1c2VybmFtZSI6ImFkbWluIiwidXNlcklkIjoxLCJwYXNzd29yZFZlcnNpb24iOjMsImlhdCI6MTYyMjE3Mjk2MCwiZXhwIjoxNjIzNDY4OTYwfQ.ngNRJSSZ6kHsPlIYIZAhZSeo4Ju6tqWWADhzmZM99OQ\"}');
INSERT INTO `base_sys_log` VALUES (4851, '2021-05-28 13:41:00.065705', '2021-05-28 13:41:00.065705', 1, '/admin/base/comm/permmenu', '127.0.0.1', '本机地址', NULL);
INSERT INTO `base_sys_log` VALUES (4852, '2021-05-28 13:41:01.583969', '2021-05-28 13:41:01.583969', 1, '/admin/base/comm/person', '127.0.0.1', '本机地址', NULL);
INSERT INTO `base_sys_log` VALUES (4853, '2021-05-28 13:41:07.040406', '2021-05-28 13:41:07.040406', 1, '/admin/base/plugin/info/list', '127.0.0.1', '本机地址', '{\"page\":1,\"size\":20,\"sort\":\"desc\",\"order\":\"createTime\"}');
INSERT INTO `base_sys_log` VALUES (4854, '2021-05-28 13:41:09.783357', '2021-05-28 13:41:09.783357', 1, '/admin/base/plugin/info/getConfig', '127.0.0.1', '本机地址', '{\"namespace\":\"redis\"}');
INSERT INTO `base_sys_log` VALUES (4855, '2021-05-28 13:41:16.559128', '2021-05-28 13:41:16.559128', 1, '/admin/base/plugin/info/config', '127.0.0.1', '本机地址', '{\"namespace\":\"redis\",\"config\":{\"redis\":\"{\\n    \\\"host\\\": \\\"redis\\\",\\n    \\\"password\\\": \\\"\\\",\\n    \\\"port\\\": 6379,\\n    \\\"db\\\": 2\\n}\"}}');
INSERT INTO `base_sys_log` VALUES (4856, '2021-05-28 13:41:48.696551', '2021-05-28 13:41:48.696551', 1, '/admin/base/plugin/info/enable', '127.0.0.1', '本机地址', '{\"namespace\":\"redis\",\"enable\":0}');
INSERT INTO `base_sys_log` VALUES (4857, '2021-05-28 13:41:51.289218', '2021-05-28 13:41:51.289218', 1, '/admin/base/plugin/info/enable', '127.0.0.1', '本机地址', '{\"namespace\":\"queue\",\"enable\":0}');
INSERT INTO `base_sys_log` VALUES (4858, '2021-05-28 13:41:54.548604', '2021-05-28 13:41:54.548604', 1, '/admin/base/plugin/info/enable', '127.0.0.1', '本机地址', '{\"namespace\":\"socket\",\"enable\":0}');
INSERT INTO `base_sys_log` VALUES (4859, '2021-05-28 13:41:58.997343', '2021-05-28 13:41:58.997343', 1, '/admin/base/plugin/info/getConfig', '127.0.0.1', '本机地址', '{\"namespace\":\"redis\"}');
INSERT INTO `base_sys_log` VALUES (4860, '2021-05-28 13:42:07.783693', '2021-05-28 13:42:07.783693', 1, '/admin/base/plugin/info/config', '127.0.0.1', '本机地址', '{\"namespace\":\"redis\",\"config\":{\"redis\":\"{\\n    \\\"host\\\": \\\"redis\\\",\\n    \\\"password\\\": \\\"\\\",\\n    \\\"port\\\": 6379,\\n    \\\"db\\\": 2\\n}\"}}');
INSERT INTO `base_sys_log` VALUES (4861, '2021-05-28 13:42:09.571676', '2021-05-28 13:42:09.571676', 1, '/admin/base/plugin/info/getConfig', '127.0.0.1', '本机地址', '{\"namespace\":\"socket\"}');
INSERT INTO `base_sys_log` VALUES (4862, '2021-05-28 13:42:15.615595', '2021-05-28 13:42:15.615595', 1, '/admin/base/plugin/info/config', '127.0.0.1', '本机地址', '{\"namespace\":\"socket\",\"config\":{\"redis\":\"{\\n    \\\"host\\\": \\\"redis\\\",\\n    \\\"password\\\": \\\"\\\",\\n    \\\"port\\\": 6379,\\n    \\\"db\\\": 2\\n}\"}}');
INSERT INTO `base_sys_log` VALUES (4863, '2021-05-28 13:42:22.622287', '2021-05-28 13:42:22.622287', 1, '/admin/base/plugin/info/enable', '127.0.0.1', '本机地址', '{\"namespace\":\"oss\",\"enable\":0}');
INSERT INTO `base_sys_log` VALUES (4864, '2021-05-28 13:42:23.714261', '2021-05-28 13:42:23.714261', 1, '/admin/base/plugin/info/enable', '127.0.0.1', '本机地址', '{\"namespace\":\"oss\",\"enable\":1}');
COMMIT;
...
CREATE TABLE `base_sys_menu` (
  ...
  `isShow` tinyint NOT NULL DEFAULT '1' COMMENT '父菜单名称',
  PRIMARY KEY (`id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `core_config` VALUES (1, '2021-05-28 13:41:16.572000', '2021-05-28 13:41:16.572000', 'redis.redis', '{\n    \"host\": \"redis\",\n    \"password\": \"\",\n    \"port\": 6379,\n    \"db\": 2\n}');
INSERT INTO `core_config` VALUES (2, '2021-05-28 13:42:15.660883', '2021-05-28 13:42:15.660883', 'socket.redis', '{\n    \"host\": \"redis\",\n    \"password\": \"\",\n    \"port\": 6379,\n    \"db\": 2\n}');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `core_module` VALUES (1, '2021-05-28 11:29:24.719361', '2021-05-28 11:29:24.719361', 'base', 1, '{\"name\":\"权限管理\",\"description\":\"基础的权限管理功能，包括登录，权限校验\",\"middlewares\":[\"baseAuthorityMiddleware\",\"baseLogMiddleware\"]}');
INSERT INTO `core_module` VALUES (2, '2021-05-28 11:29:24.792412', '2021-05-28 11:29:24.792412', 'demo', 0, '{\"name\":\"测试模块\",\"description\":\"演示示例\",\"middlewares\":[\"testMiddleware\"]}');
INSERT INTO `core_module` VALUES (3, '2021-05-28 11:29:24.847111', '2021-05-28 11:29:24.847111', 'space', 0, '{\"name\":\"文件空间\",\"description\":\"上传和管理文件资源\",\"middlewares\":[\"baseAuthorityMiddleware\",\"baseLogMiddleware\"]}');
INSERT INTO `core_module` VALUES (4, '2021-05-28 11:29:24.901013', '2021-05-28 11:29:24.901013', 'task', 1, '{\"name\":\"任务调度\",\"description\":\"任务调度模块，支持分布式任务，由redis整个集群的任务\",\"middlewares\":[\"baseAuthorityMiddleware\",\"baseLogMiddleware\"]}');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `core_plugin` VALUES (1, '2021-05-28 11:29:25.241720', '2021-05-28 13:42:23.000000', '阿里云OSS', 'cool官方', '邮箱：team@cool-js.com', '将文件上传到阿里云oss，前端签名直传方式', '1.0.12', 1, 0, 'oss', '[{\n    \"label\": \"accessKeyId\",\n    \"prop\": \"accessKeyId\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"阿里云accessKeyId\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"130px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}, {\n    \"label\": \"accessKeySecret\",\n    \"prop\": \"accessKeySecret\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"阿里云accessKeySecret\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"130px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}, {\n    \"label\": \"bucket\",\n    \"prop\": \"bucket\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"阿里云oss的bucket\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"130px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}, {\n    \"label\": \"endpoint\",\n    \"prop\": \"endpoint\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"阿里云oss的endpoint\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"130px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}, {\n    \"label\": \"timeout\",\n    \"prop\": \"timeout\",\n    \"value\": \"3600s\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"阿里云oss的timeout\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"130px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}]', 'oss:ossFileHandler', 'coolFile');
INSERT INTO `core_plugin` VALUES (2, '2021-05-28 11:29:25.411395', '2021-05-28 11:29:25.000000', '微信支付', 'cool官方', '邮箱：team@cool-js.com', '基于tenpay的微信支付', '1.0.12', 1, 0, 'wxpay', '[{\n    \"label\": \"appid\",\n    \"prop\": \"appid\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"微信应用ID\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"100px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}, {\n    \"label\": \"mchid\",\n    \"prop\": \"mchid\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"微信商户ID\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"100px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}, {\n    \"label\": \"partnerKey\",\n    \"prop\": \"partnerKey\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"微信商户秘钥\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"100px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}, {\n    \"label\": \"notify_url\",\n    \"prop\": \"notify_url\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"异步回调地址\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"100px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}, {\n    \"label\": \"证书\",\n    \"prop\": \"pfx\",\n    \"component\": {\n        \"name\": \"cl-upload\",\n        \"attrs\": {\n            \"placeholder\": \"证书\"\n        },\n        \"props\": {\n            \"list-type\": \"text\",\n            \"accept\": \"*\",\n            \"limit\": 1\n        }\n    },\n    \"props\": {\n        \"label-width\": \"100px\"\n    }\n}]', 'wxpay:sdk', NULL);
INSERT INTO `core_plugin` VALUES (3, '2021-05-28 11:29:25.427776', '2021-05-28 11:29:25.000000', '支付宝支付', 'cool官方', '邮箱：team@cool-js.com', '方便集成支付宝支付的sdk', '1.0.8', 1, 0, 'alipay', '[{\n    \"label\": \"appId\",\n    \"prop\": \"appId\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"支付宝应用ID\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"116px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}, {\n    \"label\": \"wsServiceUrl\",\n    \"prop\": \"wsServiceUrl\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"服务器地址\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"116px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n},  {\n    \"label\": \"signType\",\n    \"prop\": \"signType\",\n    \"value\": \"RSA2\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"异步回调地址\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"116px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}, {\n    \"label\": \"privateKey\",\n    \"prop\": \"privateKey\",\n    \"component\": {\n        \"name\": \"el-input\",\n        \"attrs\": {\n            \"placeholder\": \"privateKey\"\n        }\n    },\n    \"props\": {\n        \"label-width\": \"116px\"\n    }\n}, {\n    \"label\": \"alipayRootCert\",\n    \"prop\": \"alipayRootCertPath\",\n    \"component\": {\n        \"name\": \"cl-upload\",\n        \"attrs\": {\n            \"placeholder\": \"alipayRootCert\"\n        },\n        \"props\": {\n            \"list-type\": \"text\",\n            \"accept\": \"*\",\n            \"limit\": 1\n        }\n    },\n    \"props\": {\n        \"label-width\": \"116px\"\n    }\n}, {\n    \"label\": \"alipayPublicCert\",\n    \"prop\": \"alipayPublicCertPath\",\n    \"component\": {\n        \"name\": \"cl-upload\",\n        \"attrs\": {\n            \"placeholder\": \"alipayPublicCert\"\n        },\n        \"props\": {\n            \"list-type\": \"text\",\n            \"accept\": \"*\",\n            \"limit\": 1\n        }\n    },\n    \"props\": {\n        \"label-width\": \"116px\"\n    }\n}, {\n    \"label\": \"appCert\",\n    \"prop\": \"appCertPath\",\n    \"component\": {\n        \"name\": \"cl-upload\",\n        \"attrs\": {\n            \"placeholder\": \"appCert\"\n        },\n        \"props\": {\n            \"list-type\": \"text\",\n            \"accept\": \"*\",\n            \"limit\": 1\n        }\n    },\n    \"props\": {\n        \"label-width\": \"116px\"\n    }\n}]', 'alipay:sdk', NULL);
INSERT INTO `core_plugin` VALUES (4, '2021-05-28 11:29:25.432255', '2021-05-28 13:42:15.000000', 'Socket即时通讯', 'cool官方', '邮箱：team@cool-js.com', '基于socket.io的即使通讯', '1.0.8', 0, 1, 'socket', '[{\n    \"label\": \"配置\",\n    \"prop\": \"redis\",\n    \"component\": {\n        \"name\": \"cl-codemirror\",\n        \"attrs\": {\n            \"placeholder\": \"{\\\"host\\\":\\\"127.0.0.1\\\",\\\"password\\\":\\\"\\\",\\\"port\\\":6379,\\\"db\\\":2}\"\n        },\n        \"props\":{\n            \"height\": \"200px\"\n        }\n    },\n    \"value\": \"{\\\"host\\\":\\\"127.0.0.1\\\",\\\"password\\\":\\\"\\\",\\\"port\\\":6379,\\\"db\\\":2}\",\n    \"props\": {\n        \"label-width\": \"80px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}]', 'socket:coolSocketIo', NULL);
INSERT INTO `core_plugin` VALUES (5, '2021-05-28 11:29:25.438319', '2021-05-28 13:41:51.000000', '任务与队列', 'cool官方', '邮箱：team@cool-js.com', '基于redis的任务与队列，支持分布式任务(注: 配置完redis需要重启生效)', '1.0.8', 0, 1, 'queue', NULL, 'queue:coolQueue', NULL);
INSERT INTO `core_plugin` VALUES (6, '2021-05-28 11:29:25.442386', '2021-05-28 13:42:07.000000', 'Redis缓存', 'cool官方', '邮箱：team@cool-js.com', '替换系统的默认缓存为redis', '1.1.6', 0, 3, 'redis', '[{\n    \"label\": \"配置\",\n    \"prop\": \"redis\",\n    \"component\": {\n        \"name\": \"cl-codemirror\",\n        \"attrs\": {\n            \"placeholder\": \"{\\\"host\\\":\\\"127.0.0.1\\\",\\\"password\\\":\\\"\\\",\\\"port\\\":6379,\\\"db\\\":2}\"\n        },\n        \"props\":{\n            \"height\": \"200px\"\n        }\n    },\n    \"value\": \"{\\\"host\\\":\\\"127.0.0.1\\\",\\\"password\\\":\\\"\\\",\\\"port\\\":6379,\\\"db\\\":2}\",\n    \"props\": {\n        \"label-width\": \"80px\"\n    },\n    \"rules\": {\n        \"required\": true,\n        \"message\": \"值不能为空\"\n    }\n}]', 'redis:redisCacheHandler', 'coolCache');
COMMIT;
